...
export const translations = {
  ES: {
    ...
    prod_claim_free: 'Obtener Gratis',
    prod_claimed_free: 'Agregado a tu Cuenta',
  ...
  EN: {
    ...
    prod_claim_free: 'Get for Free',
    prod_claimed_free: 'Added to your Account',
  ...
  PT: {
    ...
    prod_claim_free: 'Obter Grátis',
    prod_claimed_free: 'Adicionado à sua Conta',
